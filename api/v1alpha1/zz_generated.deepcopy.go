...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ValheimServerResourceSpec) DeepCopyInto(out *ValheimServerResourceSpec) {
	*out = *in
	if in.Limits != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ValheimServerResourceSpec.
func (in *ValheimServerResourceSpec) DeepCopy() *ValheimServerResourceSpec {
	if in == nil {
		return nil
	}
	out := new(ValheimServerResourceSpec)
	in.DeepCopyInto(out)
	return out
}
